                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form enctype="multipart/form-data" class="form-horizontal" method="post"
                                ...
                                <div class="control-group">
                                    <label class="control-label">Material & Care
                                    </label>
                                    <div class="controls">
                                ...
                                <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <select name="menu_style">
                                            ...
                                            <option value="l" {{$productDetails->menu_style=='l' ? 'selected' : '' }}>List View</option>
                                            <option value="g" {{$productDetails->menu_style=='g' ? 'selected' : '' }}>Grid View(Image)</option>
                                ...
                                <div class="control-group col-md-4">
                                    ...
                                    <div class="controls">
                                        <select name="feature_products">
                                            <option value="">--- select value ---</option>
                                            <option value="1" {{$productDetails->feature_products=='1' ? 'selected' : '' }}>Yes</option>
                                            <option value="0" {{$productDetails->feature_products=='0' ? 'selected' : '' }}>No</option>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="checkbox" name="status" id="status" value= @if($productDetails->status=="1" )checked @endif value="1">
                                    </div>
                                </div>
