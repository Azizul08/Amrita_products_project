...
<head>
    <title>Salonicapizzeria Admin</title><meta charset="UTF-8" />
...
<div id="loginbox">
    <?php if(Session::has('flash_message_error')): ?>
        ...
        <?php endif; ?>
    <form id="loginform" class="form-vertical" method="post" action="<?php echo e(url('admin')); ?>">
        <?php echo e(csrf_field()); ?>

        <div class="control-group normal_text"> <h3 style="color:white">Salonicapizzeria Admin</h3></div>
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    <span class="add-on bg_lg"><i class="icon-user"> </i></span><input name="email" type="email" placeholder="Username" />
                </div>
            </div>
        </div>
        <div class="control-group">
