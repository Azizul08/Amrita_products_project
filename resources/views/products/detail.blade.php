...
@section('content')
    <section xmlns:cursor="http://www.w3.org/1999/xhtml">
        <div class="container">
            <div class="row">
                @if(Session::has('flash_message_error'))

                    <div class="alert alert-error alert-block" style="background-color: #ef8d8d">
                    ...
                    <div class="product-details"><!--product-details-->
                                ...
                                <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                                    <a href="{{asset('images/backend_images/products/large/'.$productDetails->image)}}">
                                        <img style="width: 300px;" class="mainImage"
                                             src="{{asset('images/backend_images/products/medium/'.$productDetails->image)}}" alt="" />
                                         </a>
                                </div>
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="product-information"><!--/product-information-->
                                ...
                                <!--This line has <span id="Availability" not work>-->
